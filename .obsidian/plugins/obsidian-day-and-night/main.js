...
var DayAndNight = class extends import_obsidian.Plugin {
  onload() {
...
var DayAndNightSettingTab = class extends import_obsidian.PluginSettingTab {
  ...
  addNightSettings() {
    new import_obsidian.Setting(this.containerEl).setName("Night Theme").setDesc("Select a Night Theme").addDropdown((dropdown) => dropdown.addOption("Light", "Light").addOption("obsidian", "Dark").setValue(this.plugin.settings.nightTheme).onChange((value) => {
  ...
  addDaySettings() {
    new import_obsidian.Setting(this.containerEl).setName("Day Theme").setDesc("Select a Day Theme").addDropdown((dropdown) => dropdown.addOption("Light", "Light").addOption("obsidian", "Dark").setValue(this.plugin.settings.dayTheme).onChange((value) => {
