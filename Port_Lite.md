...
SELECT trade, C.name, qty ,O.price, qty*O.price AS amount, active, reason, market, C.price, buy,  FROM orders O JOIN consensus C ON O.name  = C.name WHERE active = 2 ORDER BY trade, C.name;
